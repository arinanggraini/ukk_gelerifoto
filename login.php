...
<head>
    ...
    <title>Website Geleri Foto</title>
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css">
</head>
<body>
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container">
    <a class="navbar-brand" href="indek.php">Website Geleri Foto</a>
        ...
        <div class="col-md-4">
          <div class="card">
            <div class="card-body bg-light">
                ...
                <hr>
                <p>Belum Punya Akun? <a href="registasi.php">Daftar disini!</a></p>
            </div>
          </div>
        </div>
    </div>
...
<footer class="d-flex-justitf-content-center border-top mt-3 bg-light fixed bottom">
